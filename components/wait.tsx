...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
            ...
            <div className="text-center md:text-left">
              ...
              >
                ...
                >
                  <Button
                    type="submit"
                    className="h-12 w-full rounded-lg bg-[#111] hover:bg-[#222] hover:text-purple-300"
                    variant="outline"
                  >
              ...
              >
                <Link
                  ...
                  href="https://x.com/iventverse?s=09"
                  target="_blank"
                >
                  <svg
                    className="h-5 w-5"
      ...
      <footer className="mt-[30px] mb-0 text-center text-xs">
